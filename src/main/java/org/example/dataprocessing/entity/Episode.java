...
public class Episode extends Content
{
    ...
    public Episode(Long contentId, String title, String description, List<Genre> genres, AgeRating ageRating, List<String> supportedQualities, Long episodeId, int episodeNumber, int seasonNumber, int duration, Serie serie)
    {
